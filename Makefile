...
epub:	hevea
	ebook-convert html/index.html thinkpython.epub --author-sort=Downey --authors="Allen B. Downey" --book-producer="Green Tea Press" --cover=cover.png --title="Think Python" --language=en
